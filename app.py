        ...
        if st.session_state.product_info:
            ...
            with st.expander("🖼️ 2.4 ฉากหลังและบรรยากาศ", expanded=True):
                bg_options = [
                    ...
                    "ห้องแต่งตัว/ลองชุด (Fitting Room สวยๆ มีกระจก) 👗",
                    "ร้านเสื้อผ้าเด็ก (น่ารัก สดใส สีพาสเทล) 🧸",
                    "ร้านเสื้อผ้าผู้ใหญ่/วัยทำงาน (เรียบหรู ดูภูมิฐาน) 👔",
                    "ร้านเสื้อผ้าแฟชั่นวัยรุ่น/สตรีท (ฮิปๆ คูลๆ) 🛹",
                    "บูติกไฮเอนด์สุดหรู (พรีเมียม ไม่มีโลโก้แบรนด์) ✨",
                    "สตูดิโอถ่ายแบบพื้นหลังเรียบๆ (เน้นสินค้าล้วนๆ) 📸",
                    "ในเมือง/ถนนชิคๆ 🏙️", 
                    "คาเฟ่/ร้านมินิมอล ☕",
                    "ตลาด/สตรีทฟู้ด 🥢", 
                    "ห้างสรรพสินค้า 🛍️", 
...
{scene_rule}
{script_instruction}
   - **กฎการเลี่ยงลิขสิทธิ์ (CRITICAL COPYRIGHT & SAFETY):** ในการเขียน `image_prompt` และ `video_prompt` **ห้ามใช้ชื่อแบรนด์เนมจริง (เช่น Nike, Apple, Chanel)**, ห้ามใช้ชื่อคนดัง, ห้ามใช้ตัวละครมีลิขสิทธิ์, และห้ามพิมพ์คำว่า TikTok, Instagram, หรือ Reels ลงใน Prompt เป็นอันขาด! ให้ใช้คำกลางๆ เช่น "unbranded premium fashion", "social media style video", "generic boutique" แทน เพื่อป้องกันระบบ Video AI บล็อกคำสั่ง (Error: third-party content providers)
