...
class TikTokPostData(BaseModel):
    product_details: str = Field(description="1. รายละเอียดสินค้าที่วิเคราะห์จากภาพ (ชื่อ, จุดเด่น, สรรพคุณ 3-4 บรรทัด)")
    overlay_text: str = Field(description="2. ข้อความพาดหัวฮุคคนดู (สั้นๆ ไม่เกิน 10 คำ) เขียนแยกข้อความตามแต่ละซีนของคลิปวิดีโอ")
...
class VideoPlan(BaseModel):
    ...
    tiktok_post_data: Optional[TikTokPostData] = Field(description="ข้อมูลแคปชั่น แฮชแท็ก และรายละเอียดสำหรับโพสต์คลิปนี้ลง TikTok", default=None)
